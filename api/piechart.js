...
function handler (req, res) {
  ...
  con.connect(async (err) => {
    ...
    let sql = 'SELECT Count(TaskId) As "Count", Sum(TimeTaken) As "Sum", TaskType FROM Tasks Where EmployeeId="' + req.EmployeeId + '" AND TaskType="Break" AND StartDate BETWEEN "' + req.StartDate + '" AND "' + req.EndDate + '"'
